...
// יצירת סשן חדש
async function createSessionService(params: { title: string; description: string; ownerUid: string; }): Promise<sessions> {
...
// הצטרפות לסשן קיים
async function joinSessionService(sessionId: number, userId: string): Promise<'created' | 'exists'> {
